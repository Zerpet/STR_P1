...
# GENERATED: Tue Apr 10 11:57:43 +0200 2012
...
PRJ_FILE       = STR.wpj
PRJ_FULL_PATH  = D:/Documentos/STR/workspace/STR
PRJ_TYPE       = vxWorks
PRJ_OBJS       = sysALib.o sysLib.o usrAppInit.o usrRtpAppInit.o prjConfig.o linkSyms.o controladorA.o displayA.o
...
RAM_LOW_ADRS = 10010000
RAM_HIGH_ADRS = ffffffff
LOCAL_MEM_LOCAL_ADRS = 10000000
...
CFLAGS           = -g -tX86LH:vxworks68 -W:c:,-Xclib-optim-off -Xansi -Xlocal-data-area-static-only -Xsize-opt -W:c:,-Xmismatch-warning=2 -ew1554,1551,1552,1086,1047,1547 -ei1516,1643,1604 -Xlint -D_VSB_CONFIG_FILE=\"$(VSB_CONFIG_FILE)\" -I$(PRJ_DIR) -I$(BSP_DIR) -I$(TGT_DIR)/h -I$(TGT_DIR)/config/comps/src -I$(TGT_DIR)/h/wrn/coreip -I$(TGT_DIR)/src/drv -DCPU=SIMNT -DTOOL_FAMILY=diab -DTOOL=diab -DPRJ_BUILD -D_WRS_KERNEL -I$(WIND_HOME)/components/ip_net2-6.8/osconfig/vxworks/src -I$(WIND_HOME)/components/ip_net2-6.8/osconfig/vxworks/h -I$(TGT_DIR)/src/hwif -I$(TGT_DIR)/src/hwif/h @./ipcom_ipdomain -DIP_PORT_VXWORKS=68 -DINET -I.
CFLAGS_AS        = -g -tX86LH:vxworks68 -W:c:,-Xclib-optim-off -Xansi -Xlocal-data-area-static-only -Xsize-opt -Xpreprocess-assembly -Xcpp-no-space -Wa,-Xmnem-mit -D_VSB_CONFIG_FILE=\"$(VSB_CONFIG_FILE)\" -I$(PRJ_DIR) -I$(BSP_DIR) -I$(TGT_DIR)/h -I$(TGT_DIR)/config/comps/src -I$(TGT_DIR)/h/wrn/coreip -I$(TGT_DIR)/src/drv -DCPU=SIMNT -DTOOL_FAMILY=diab -DTOOL=diab -DPRJ_BUILD -D_WRS_KERNEL -I$(WIND_HOME)/components/ip_net2-6.8/osconfig/vxworks/src -I$(WIND_HOME)/components/ip_net2-6.8/osconfig/vxworks/h -I$(TGT_DIR)/src/hwif -I$(TGT_DIR)/src/hwif/h @./ipcom_ipdomain -DIP_PORT_VXWORKS=68 -DINET -I.
CFLAGS_AS_PROJECT = -g -tX86LH:vxworks68 -W:c:,-Xclib-optim-off -Xansi -Xlocal-data-area-static-only -Xsize-opt -I$(TGT_DIR)/config/all -I$(TGT_DIR)/h -I$(WIND_HOME)/components/ip_net2-6.8/osconfig/vxworks/src -I$(WIND_HOME)/components/ip_net2-6.8/osconfig/vxworks/h -I$(TGT_DIR)/src/hwif -I$(TGT_DIR)/src/hwif/h @./ipcom_ipdomain -I. -I$(TGT_DIR)/h/wrn/coreip -I$(TGT_DIR)/src/config -I$(TGT_DIR)/config/comps/src -I$(TGT_DIR)/config/comps/src/dosfs2 -I$(TGT_DIR)/src/drv -I$(TGT_DIR)/src/hwif/h -DCPU=SIMNT -DTOOL_FAMILY=diab -DTOOL=diab -D_WRS_KERNEL -DIP_PORT_VXWORKS=68 -DINET -Xpreprocess-assembly -Xcpp-no-space -Wa,-Xmnem-mit -D_VSB_CONFIG_FILE=\"$(VSB_CONFIG_FILE)\"
CFLAGS_PROJECT   = -g -tX86LH:vxworks68 -W:c:,-Xclib-optim-off -Xansi -Xlocal-data-area-static-only -Xsize-opt -W:c:,-Xmismatch-warning=2 -ew1554,1551,1552,1086,1047,1547 -ei1516,1643,1604 -Xlint -I$(TGT_DIR)/config/all -I$(TGT_DIR)/h -I$(WIND_HOME)/components/ip_net2-6.8/osconfig/vxworks/src -I$(WIND_HOME)/components/ip_net2-6.8/osconfig/vxworks/h -I$(TGT_DIR)/src/hwif -I$(TGT_DIR)/src/hwif/h @./ipcom_ipdomain -I. -I$(TGT_DIR)/h/wrn/coreip -I$(TGT_DIR)/src/config -I$(TGT_DIR)/config/comps/src -I$(TGT_DIR)/config/comps/src/dosfs2 -I$(TGT_DIR)/src/drv -I$(TGT_DIR)/src/hwif/h -DCPU=SIMNT -DTOOL_FAMILY=diab -DTOOL=diab -D_WRS_KERNEL -DIP_PORT_VXWORKS=68 -DINET -D_VSB_CONFIG_FILE=\"$(VSB_CONFIG_FILE)\"
CPP              = dcc -E -Xpreprocessor-lineno-off
DOC_FILES        = sysLib simSio hostSio simnetEnd
EXTRA_MODULES    = $(SUB_TARGETS)
LD               = dld
LD_LINK_PATH     = -L$(VSB_DIR)/simpc/SIMNT/diab_standard -L$(VSB_DIR)/simpc/SIMNT/diab -L$(VSB_DIR)/simpc/SIMNT/common -L$(WS_ROOT_DIR)/obj/vxworks-6.8/krnl/lib/simpc/SIMNT/diab -L$(WS_ROOT_DIR)/obj/vxworks-6.8/krnl/lib/simpc/SIMNT/common -L$(WIND_HOME)/components/obj/vxworks-6.8/krnl/lib/simpc/SIMNT/diab -L$(WIND_HOME)/components/obj/vxworks-6.8/krnl/lib/simpc/SIMNT/common
LD_PARTIAL       = dld -tX86LH:vxworks68 -X -r5 -f 0x90,1,1
LD_PARTIAL_FLAGS = -tX86LH:vxworks68 -X -r5 -f 0x90,1,1
LIBS             = $(VX_OS_LIBS)
NM               = ddump -Ng -g
...
controladorA.o:  $(PRJ_DIR)/controladorA.c 
	$(RM) controladorA.o
	$(CC) $(CFLAGS) $(CFLAGS_OPTIONS_ALL) -c $(PRJ_DIR)/controladorA.c

displayA.o:  $(PRJ_DIR)/displayA.c 
	$(RM) displayA.o
	$(CC) $(CFLAGS) $(CFLAGS_OPTIONS_ALL) -c $(PRJ_DIR)/displayA.c
endif
